...
class feed extends StatelessWidget {
  ...
  feed({super.key, required this.username, required this.email});
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: SizedBox(
                  width: 285,
                  child: Text('To Improve your Speaking skills in English you should consider the following suggestions',
                    style: TextStyle(
                      fontSize: 15,
                    ),),
                ),),
